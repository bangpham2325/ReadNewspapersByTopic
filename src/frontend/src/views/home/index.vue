        ...
        <div class="tile is-parent" @click="detailPost(post.slug)">
          <div class="tile is-child box card">
            ...
            <div class="card-content">
              ...
              <el-row>
                <el-col :span="12">
                  <el-button type="text" icon="Star" style="color:black;padding:0 !important" size="large" class="title is-6 mt-1" v-if="post.avg_rating != null">{{ Number((post.avg_rating).toFixed(1)) }}/5</el-button>
