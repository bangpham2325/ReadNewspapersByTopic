...
CRONJOBS = [
    ('*/59 5,17 * * *', 'api_post.services.craw.thread_crawl_vietcetera'),
    ('*/59 5,11,17 * * *', 'api_post.services.craw.thread_crawl_dantri'),
    ('*/59 5,11,17 * * *', 'api_post.services.craw.thread_crawl_vnexpress'),
    ('*/59 5,11,17 * * *', 'api_post.services.craw.thread_crawl_vietnamnet'),
]
